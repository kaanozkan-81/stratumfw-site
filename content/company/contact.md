---
title: "Contact"
lead: "Whether you're evaluating Stratum Gateway, need support, or want to partner with us — here's how to reach the right people."
---

## General inquiries

For anything related to evaluation, deployment questions, pricing (there is none — it's open source), or a general introduction:
...
For technical documentation, installation guides, and API reference, see the documentation site:

<div class="contact-card">
  <div class="contact-card-label">Documentation</div>
  <a href="https://update.stratumfw.com" class="contact-card-value">update.stratumfw.com</a>
  <p class="contact-card-note">Always up to date with the current release.</p>
</div>

## Try before you contact

You don't have to talk to us to see what Stratum Gateway does. The live dashboard runs a fully functional instance — every module, every feature, no signup required.

<div style="margin-top:32px;">
  <a href="/try-me/" class="btn btn-primary">Open the live dashboard</a>
</div>

---

<p style="margin-top:48px; color:var(--ash); font-size:14px; text-align:center;">
  <strong>Stratum Security</strong><br>
  Building network security tools for the people who run the network.
</p>
